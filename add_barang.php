...
$insert = $_POST['insert'];
 ...
 function autoNumber(){
  ...
  $sort_num++;
  $char = "";
  $new_code = $char . sprintf("%04s", $sort_num);
  return $new_code;
 }
?>
...
$query = "SELECT max(barcode) as maxKode FROM barang ORDER BY barcode";
$hasil = mysqli_query($conn,$query);
$data = mysqli_fetch_array($hasil);
$kodeBarang = $data['maxKode'];

// mengambil angka atau bilangan dalam kode anggota terbesar,
// dengan cara mengambil substring mulai dari karakter ke-6 diambil 4 karakter setelah karakter 6
// misal 'IDWARE001', akan diambil '001'
// setelah substring bilangan diambil lantas dicasting menjadi integer
$noUrut = (int) substr($kodeBarang, 6, 4);
...
$char = "";    // inisial kode barcode terdiri atas 6 karakter, ini bisa kamu ganti sesuai kebutuhan
              ...
              <div class="box-body">
                ...
                <div class="row">
                        <div class="form-group col-md-6 col-xs-12" >
                          <label for="kode" class="col-sm-3 control-label">Kode Barang:</label>
                          <div class="col-sm-9">
                           <?php  if($no == null || $no ==""){ ?>
...
<?php
    ...
    ?>
      ...
      <div class="col-sm-3">
                <input type="hidden" id=autobar name=autobar class="form-control" value="<?php echo barcode(); ?>" >
              </div>
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
             move_uploaded_file($tmp, $avatar);
                  $sql1 = "update $tabeldatabase set nama='$nama', kategori='$kategori', keterangan='$keterangan', avatar='$avatar' where kode='$kode'";
          ...
          move_uploaded_file($tmp, $avatar);
            $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$keterangan','$kategori','','','','','$avatar')";
