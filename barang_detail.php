            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Keluar</b> <a class="pull-right"><?php  echo number_format(($terjual), $decimal, $a_decimal, $thousand).''; ?></a>
                </li>
                <li class="list-group-item">
                  <b>Masuk</b> <a class="pull-right"><?php  echo number_format(($terbeli), $decimal, $a_decimal, $thousand).''; ?></a>
                </li>
                <li class="list-group-item">
                  <b>Stok</b> <a class="pull-right"><?php  echo number_format(($sisa), $decimal, $a_decimal, $thousand).''; ?></a>
                </li>
              </ul>
