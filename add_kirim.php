...
$halaman = "kirim"; // halaman
$dataapa = "Kirim"; // data
$tabeldatabase = "kirimdata"; // tabel database
...
$insert = $_POST['insert'];
 ...
 function autoNumber(){
  ...
  global $forward;
  $query = "SELECT MAX(RIGHT(nota, 4)) as max_id FROM kirim ORDER BY nota";
    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $total = mysqli_num_rows($result);
               ...
               echo "<script type='text/javascript'>window.location = 'add_req';</script>";
             }else{
...
<div class="form-group col-md-12 col-xs-12" >
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
           ...
           $sql    = "select * from reqdata where nota =".autoNumber()." order by no";
           $result = mysqli_query($conn, $sql);
           $rpp    = 15;
