    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $total = mysqli_num_rows($result);
               ...
               echo "<script type='text/javascript'>window.location = 'user_request';</script>";
             }else{
                    ...
                    <div class="box box-info">
                      <div class="box-body">
                        ...
                        <div class="form-group col-md-6 col-xs-12" >
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $autonum; ?>" maxlength="50" required readonly>
                  </div>
                </div>
                  <div class="form-group col-md-6 col-xs-12" >
...
<div class="form-group col-md-12 col-xs-12" >
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="cabang" name="cabang" value="<?php echo $cabang; ?>" maxlength="50" readonly>
                  </div>
...
<div class="form-group col-md-12 col-xs-12" >
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="unit" name="unit" value="<?php echo $unit; ?>" maxlength="50" readonly>
                  </div>
