...
?>
  ...
  <div class="login-logo">
    <img src="<?php echo $logo;?>" height="90" width="280">
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="op.php" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="txtpass" id="myInput" placeholder="Password" maxlength="20" required>
    ...
    <!-- /.social-auth-links -->
  <br>
    <p class="login-box-msg"> iBama <br/>Inventory Batara Magelang </p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
