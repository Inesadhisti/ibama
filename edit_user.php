...
<li><a href="user_profil?no=<?php echo $no;?>">Profil</a></li>
<?php
...
<?php
    ...
    $username=$password=$nama=$alamat=$nohp=$tglaktif=$avatar=$jabatan=$insert=$no="";
    $no = $_GET["no"];
    $insert = '1';
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
              ...
              if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
                      ...
                      $sql1 = "update $tabeldatabase set nama='$nama', nohp='$nohp', alamat='$alamat', cabang='$cabang', kodeunit='$unit', jabatan='$jabatan',avatar='$avatar' where userna_me='$username'";
                      $updatean = mysqli_query($conn, $sql1);
                      echo "<script type='text/javascript'>window.location = 'user-profil?no=$no';</script>";
            ...
            <form role="form" method="post" action="edit_user.php?no=<?php echo $no;?>" id="Myform" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">User Name (tidak bisa diganti)</label>
                  <input type="text" class="form-control" id="username" name="username" value="<?php echo $username;?>" placeholder="User Name baru" readonly>
                </div>
