                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            ...
                                            <?php if ($_SESSION['jabatan'] == 'admin') {?>
                                              <a href="user_profil?no=<?php echo $nouser;?>" class="btn btn-default btn-flat">Profil Admin</a>
                                              <?php } else {?>
                                                 <a href="user-profil?no=<?php echo $nouser;?>" class="btn btn-default btn-flat">Profil User</a>
                                              <?php } ?>
                                        </div>
