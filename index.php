                       ...
                       <div class="col-lg-3 col-xs-6">
                         ...
                         <div class="small-box bg-green">
                             <div class="inner">
                                 ...
                                 <p>Request perlu diproses</p>
                             </div>
                             <div class="icon">
                                 <i class="ion ion-person"></i>
                             </div>
                               <a href="request" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></a>
                         </div>
                     </div>
                   ...
                   <div class="col-lg-3 col-xs-6">
                     ...
                     <div class="small-box bg-red">
                         <div class="inner">
                             ...
                             <p>Barang dibawah <?php echo $alert;?> </p>
                         </div>
                         <div class="icon">
        ...
        <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="alert alert-info alert-dismissible">
                    <?php 
                    $rex = "SELECT avatar from pic where id=1";
                    $que = mysqli_query($conn, $rex);
                    $assoc = mysqli_fetch_assoc($que);
                    ?>
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-info"></i> Copy Paste link dibawah untuk insert gambar</h4> 
                <div id="myDiv" ><?php echo $_SESSION['baseurl']; ?>/<?php echo $assoc['avatar'];?></div>
              </div>
            <?php } else {}?>
...
<div class="row">
 <!-- Left col -->
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">5 Unit dgn Permintaan Tertinggi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
               ...
               <thead>
<?php
          $mySql  = "SELECT unit,cabang, COUNT(unit) FROM req GROUP BY cabang,unit ORDER BY COUNT(unit) DESC LIMIT 5";
         ...
         <?php       while ($kolomData = mysqli_fetch_array($myQry)) {
            $nomor++;  ?>
              ...
              <td><?php echo $kolomData['cabang']; ?></td>
              <td><?php echo $kolomData['unit']; ?></td>
              <td><?php  $caba=$kolomData['cabang'];
                $uni= $kolomData['unit'];
                $sqlx2="SELECT SUM(reqdata.jumlah) AS data FROM req INNER JOIN reqdata on req.nota=reqdata.nota where req.cabang='$caba' and req.unit='$uni' ";
  ...
  echo $row['data']; ?>
              ...
              <td><?php  $caba=$kolomData['cabang'];
                $uni= $kolomData['unit'];
                $sqlx2="SELECT SUM(reqdata.disetujui) AS data FROM req INNER JOIN reqdata on req.nota=reqdata.nota where req.cabang='$caba' and req.unit='$uni' ";
  $hasilx2=mysqli_query($conn,$sqlx2);
  $row=mysqli_fetch_assoc($hasilx2);
  echo number_format(($row['data']), $decimal, $a_decimal, $thousand).''; ?>  
              </td>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">5 Barang Paling Banyak dikirim <span class="badge bg-red">dari  #<?php  echo number_format(($stok2), $decimal, $a_decimal, $thousand).''; ?> dikirim</span></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
...
<?php
         ...
         <?php       while ($kolomData = mysqli_fetch_array($myQry)) {
            $nomor++;  ?>
              ...
              <td><?php  echo number_format(($kolomData['terjual']), $decimal, $a_decimal, $thousand).''; ?></td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="simpan2" class="btn btn-primary">Save changes</button>
                </form>
              </div>
              </div>
            </div>
...
$brex = "SELECT url from backset ";
                    $bque = mysqli_query($conn, $brex);
                    $bassoc = mysqli_fetch_assoc($bque);
                    $url = $bassoc['url'];
...
$avatar = "dist/pengumuman/".$namaavatar;
$sql="select * from pic where id='$id' ";
       $result=mysqli_query($conn,$sql);
   if(mysqli_num_rows($result)>0){
    if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000)) && ($_SESSION['jabatan'] == 'admin')){
         move_uploaded_file($tmp, $avatar);
         $sql1 = "update pic set avatar='$avatar' where id='$id' ";
         $updatean = mysqli_query($conn, $sql1);
         echo "<script type='text/javascript'>  alert('Berhasil, Data berhasil diupdate!');</script>";
         echo "<script type='text/javascript'>window.location = 'index?modal=1';</script>";
