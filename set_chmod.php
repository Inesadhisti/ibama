...
?>
  ...
  ?>
                ...
                <div class="form-group">
                  <label for="menu1" class="col-sm-3 control-label">Menu User </label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu2" class="col-sm-3 control-label">Menu Cabang dan Unit</label>
                  <div class="col-sm-9">
         ...
         <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Menu Request (Admin)</label>
                  <div class="col-sm-9">
        ...
        <div class="form-group">
                  <label for="menu6" class="col-sm-3 control-label">Menu Permintaan (User)</label>
                  <div class="col-sm-9">
        ...
        <div class="form-group">
                  <label for="menu7" class="col-sm-3 control-label">Menu Rekap</label>
                  <div class="col-sm-9">
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="menu8" name="menu8" placeholder="Masukkan Hak Akses" value="<?php echo $menu8; ?>" maxlength="1">
                            ...
                            <input type="hidden" class="form-control" id="menu9" name="menu9" placeholder="Masukkan Hak Akses" value="5" maxlength="1">
