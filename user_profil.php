...
?>
 <li class="active">Data Profil Admin</li>
  <?php
} else {
?>
        ...
        <div class="col-md-3">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Telpon</b> <a class="pull-right"><?php echo $nohp;?></a>
                </li>
                <li class="list-group-item">
                  <b>Cabang</b> <a class="pull-right"><?php echo $cabang;?></a>
                </li>
                <li class="list-group-item">
                  <b>Unit Kerja</b> <a class="pull-right"><?php echo $unit;?></a>
                </li>
              </ul>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p ><h3><span class="label label-danger"><?php echo $nohp;?></span></h3></p>


              <hr>

             <p ><h3><span class="label label-success"><?php echo $lahir1;?></span></h3></p>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" value="<?php echo $nama;?>" disabled  placeholder="Name">
                    </div>
                  </div>
                  <div class="form-group">
