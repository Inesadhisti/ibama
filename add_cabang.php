...
$halaman = "cabang"; // halaman
$dataapa = "Cabang"; // data
$tabeldatabase = "cabang"; // tabel database
   ...
   <div class="container-fluid">
        ...
        <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  <label for="kode" class="col-sm-3 control-label">Kode Kantor:</label>
                  <div class="col-sm-9">
                   <?php  if($no == null || $no ==""){ ?>
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  <label for="nama" class="col-sm-3 control-label">Nama Kantor:</label>
                  <div class="col-sm-9">
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$alamat','$nohp','')";
