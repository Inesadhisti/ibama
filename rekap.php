...
<?php
    ...
    $sql    = "select * from req inner join reqdata on req.nota=reqdata.nota where req.cabang like '%$cabang%' and req.unit like '%$unit%' and (req.tglreq BETWEEN '$awal' and '$akhir') group by reqdata.kode";
...
<div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Hasil Rekapitulasi <?php  echo $awal;?> sampai <?php  echo $akhir;?> </h3>
...
<div class="box-body table-responsive">
    ...
    if ($search != null || $search != "") {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $query1    = "select * from req inner join reqdata on req.nota=reqdata.nota where req.cabang like '%$cabang%' and req.unit like '%$unit%' and (req.tglreq BETWEEN '$awal' and '$akhir') group by reqdata.kode";
...
<div align="right"  style="padding-right:15px"  class="no-print" id="no-print" >
             <div align="left" class="no-print" id="no-print"> 
               <a onclick="window.location.href='rekap_csv?cabang=<?php echo $cabang;?>&unit=<?php echo $unit;?>&awal=<?php echo $awal;?>&akhir=<?php echo $akhir;?>'" class="btn btn-default btn-flat" value="export excel"><span class="glyphicon glyphicon-save-file"></span></a>
               </div> <br/>
             </div>
                               </div>
                                <!-- /.box-body -->
