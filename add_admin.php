...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
    ...
    $username=$password=$nama=$alamat=$nohp=$tglaktif=$unit=$avatar=$jabatan=$insert=$no="";
    $no = $_GET["no"];
    $insert = '1';
    ...
    <?php
      ...
      if (trim($_POST['nama'])=="") {
        $pesanError[] = "<b>Nama</b> tidak boleh kosong !";    
                      ...
                      $unit= mysqli_real_escape_string($conn, $_POST["kodeunit"]);
...
if (count($pesanError)>=1 ){
        ...
        echo "</div>"; 
            ...
            $result=mysqli_query($conn,$sql);
              ...
              if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
                      ...
                      echo "<script type='text/javascript'>  alert('Gagal, User Name telah dipakai silahkan pakai username lain!');</script>";
      ...
      <input type="hidden" name="hapusberhasil" value="3" />
               ...
               $sql2 = "insert into $tabeldatabase values( '$username','$password','$nama','$alamat','$nohp','$cabang','$unit','$jabatan','$avatar','')";
...
<?php } ?>
        ...
        <div class="row">
                <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    ...
                    <?php }else{ ?>
                    <input type="text" class="form-control" autocomplete="off" id="username" name="username" value="<?php echo $username; ?>"  placeholder="Masukan Username" maxlength="20" required>
                    <?php } ?>
        ...
        <div class="row">
           <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password" name="password" value="<?php echo $password; ?>" placeholder="Minimal 6 karakter" maxlength="12" required>
...
<?php if($no != null || $no != ""){}else{ ?>
        <div class="row">
           <div class="form-group col-md-12 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" id="password2" name="password2" placeholder="Masukan Password Lagi" maxlength="12" required>
                  </div>
                </div>
        </div>
<?php } ?>
        ...
        <div class="row">
               <div class="form-group col-md-12 col-xs-12" >
                 <label for="alamat" class="col-sm-3 control-label">Alamat Kantor:</label>
                 <div class="col-sm-9">
      ...
      <div class="row">
         <div class="form-group col-md-12 col-xs-12" >
                <label for="tglaktif" class="col-sm-3 control-label">Kantor:</label>
                <div class="col-sm-9">
...
<div class="row">
         <div class="form-group col-md-12 col-xs-12" >
                <label for="kodeunit" class="col-sm-3 control-label">Unit Kerja:</label>
                <div class="col-sm-9">
                  <select class="form-control select2" style="width: 100%;" name="kodeunit" required>
          <?php
