...
<li><a href="stok_barang"><?php echo $dataapa ?></a></li>
<?php
...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
        ...
        <div class="col-md-6" >
          ...
          <div class="box box-info">
              ...
              <div class="box-body">
                <div class="form-group">
                 <label for="inputEmail3" class="col-sm-2 control-label">Kode Barang</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Ketikan kode barang disini">
                  </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Keluar</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Masuk</label>
       ...
       function sum2() {
             ...
             if (!isNaN(result)) {
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo $sisa;?>" readonly="readonly" id="stok" name="stok" placeholder="Stok tersedia saat ini">
                  </div>
                </div>
 ...
 <?php
       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $sisa = $stok;
              $masuk = $jumlah + $terbeli;
              $kasir = $_SESSION["username"];
              $kegiatan = "menambah stok";
              $status = "berhasil";
              $nota = "keterangan tidak tersedia";
            $insert = ($_POST["insert"]);
             unset($_SESSION['i']);


              if(($chmod >= 3 || $_SESSION['jabatan'] == 'admin')&&($sisa >='0')){
                      $sql1 = "update $tabeldatabase set terjual='$terjual', terbeli='$masuk', sisa='$sisa' where kode='$kode'";
